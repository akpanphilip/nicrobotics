...
<body>
    ...
    <div class="container">
        <div class="sectionTab">
            ...
            <p>Last updated: September 20, 2021 </p>
            <p>NIC Bot is a bot that was created for automated trading on the ExpertOption platform. To use the
                Site
                and the App you must agree to the below terms, so please read them carefully.</p>
            <ol>
                <li>INTRODUCTION</li>
                <p>1.1 These Terms and Conditions (the Terms) govern the use of certain services, including
                    accessing the website www.expertoptionbot.com with all its subpages, related subdomains and
                    domains with URL redirection to that website (the Site), using the ExpertBot application
                    available at Google Play via the link , and/or browser extension available via the link (the
                    App) (collectively, the Services), provided by ExpertBot (the Company or we) to any
                ...
                <p>1.2 If you have any questions regarding these Terms or about the Company, please contact us
                    by email at support@nicrobotics.com.</p>
                <li>ACCEPTANCE</li>
                <p>
                ...
                <li>PRIVACY</li>
                <p>
                    3.1 Please refer to our Privacy Policy that is an integral part of these Terms, for
                ...
                <p>
                    ...
                    belief may infringe someone’s copyright, you may notify us by emailing us at support@nicrobotics.com
                ...
                <p>
                    ...
                    (individually and collectively, the Indemnified Parties), from and against all actual or alleged
